...
class SoftmaxModel(Model):
    ...
    def add_training_op(self, loss):
        ...
        Creates an optimizer(训练器) and applies the gradients（梯度） to all trainable variables.
        ...
        """
        # YOUR CODE HERE
        # 定义一个实现梯度下降算法的优化器（lr learn rate）
